...
#### Answer:checked database and noticed there is no relation between entities which provided in this diagram ![alt text](https://github.com/qasirdev/eurocamp-fe-test/blob/main/public/ERD.jpg)

## Task 2 (10 minutes)

- Brief explanation of the latest practices in your respective field of expertise.

#### Answer: I worked with React more than 3 years and more than 1.5 years I am working with Nextjs. My latest work with graphql is [Server](https://github.com/qasirdev/weatherbys-graphql-server), [Client](https://github.com/qasirdev/weatherbys-graphql-client). I am using Prisma ORM for database qureies. I prefer to build my projects in Nextjs by using app router with typscript.  
...
#### Answer: Frontend is build with Nexjs 14 with app router and typescript. For  [Step by step guide - click here](https://github.com/qasirdev/eurocamp-fe-test/blob/main/public/Step-by-step-guide-for-eurocamp.docx)  
